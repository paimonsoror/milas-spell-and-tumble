...
// js/*.js became real ES modules. Deliberately every non-DOM file app.js
// imports (js/passages.js joined the set with HANDOFF-PARAGRAPH.md) —
// audio.js/app.js need a DOM and stay out of this harness.
export * from "../js/words.js";
export * from "../js/letters.js";
export * from "../js/language.js";
export * from "../js/passages.js";
